...
def test_create_compensation_report():
    employees = [
        ...
        Employee(**{"name": "Bob", "base_salary": 10000, "years_of_service": 8}),
        Employee(**{"name": "Charlie", "base_salary": 12000, "years_of_service": 10}),
    ]
...
def test_given_employee_record_when_enrich_then_original_data_should_not_change():
    employee = Employee(**{"name": "Alice", "base_salary": 8000, "years_of_service": 5})
